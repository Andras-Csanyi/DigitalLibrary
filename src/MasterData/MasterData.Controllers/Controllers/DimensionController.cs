...
namespace DigitalLibrary.MasterData.Controllers
{
    ...
    public class DimensionController : ControllerBase
    {
        ...
        public async Task<ActionResult<Dimension>> AddDimensionAsync(Dimension dimension)
        {
            try
            {
                Dimension result = await _masterDataBusinessLogic.MasterDataDimensionBusinessLogic.AddDimensionAsync(
                        dimension)
        ...
        public async Task<ActionResult> DeleteDimensionAsync(Dimension dimension)
        {
            try
            {
                await _masterDataBusinessLogic.MasterDataDimensionBusinessLogic.DeleteDimensionAsync(dimension)
                   .ConfigureAwait(false);
                return Ok();
            }
            catch (Exception e)
        ...
        public async Task<ActionResult<List<Dimension>>> GetActiveDimensions()
        {
            try
            {
                List<Dimension> result = await _masterDataBusinessLogic.MasterDataDimensionBusinessLogic
                   .GetDimensionsAsync()
                   .ConfigureAwait(false);
                return result;
            }
        ...
        public async Task<ActionResult<Dimension>> GetDimensionById(long dimensionId)
        {
            try
            {
                Dimension result = await _masterDataBusinessLogic.MasterDataDimensionBusinessLogic
                   .GetDimensionByIdAsync(dimensionId)
                   .ConfigureAwait(false);
                return result;
            }
            catch (Exception e)
        ...
        public async Task<ActionResult<List<Dimension>>> GetDimensionsWithoutStructure()
        {
            ...
            {
                List<Dimension> result = await _masterDataBusinessLogic.MasterDataDimensionBusinessLogic
                   .GetDimensionsWithoutStructureAsync()
                   .ConfigureAwait(false);
                return result;
            }
            catch (Exception e)
        ...
        public async Task<ActionResult<Dimension>> ModifyDimensionAsync(Dimension dimension)
        {
            try
            {
                Dimension result = await _masterDataBusinessLogic.MasterDataDimensionBusinessLogic.UpdateDimensionAsync(
                        dimension)
                   .ConfigureAwait(false);
                return Ok(result);
            }
