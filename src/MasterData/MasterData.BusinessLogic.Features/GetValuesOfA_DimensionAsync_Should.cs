// // <copyright file="GetValuesOfA_DimensionAsync_Should.cs" company="Andras Csanyi">
...
//     public class GetValuesOfA_DimensionAsync_Should : SourceFormatFeature
//     {
...
//                 IsActive = 1,
//             };
//             DomainModel.Dimension dimensionResult = await _masterDataBusinessLogic
...
//                 Value = "value",
//             };
//             DomainModel.DimensionValue dimensionValueResult = await _masterDataBusinessLogic
//                .AddDimensionValueAsync(
//                     dimensionValue, dimensionResult.Id)
//                .ConfigureAwait(false);
//
//             // Act
//             DomainModel.Dimension result = await _masterDataBusinessLogic
...
//                 Value = "value2",
//             };
//             DomainModel.DimensionValue dimensionValueResult2 = await _masterDataBusinessLogic
//                .AddDimensionValueAsync(
...
//                 Value = "value3",
//             };
//             DomainModel.DimensionValue dimensionValueResult3 = await _masterDataBusinessLogic
//                .AddDimensionValueAsync(
...
//
//             // Act
//             DomainModel.Dimension result = await _masterDataBusinessLogic.GetValuesOfADimensionAsync(100)
//                .ConfigureAwait(false);
//
//             // Assert
