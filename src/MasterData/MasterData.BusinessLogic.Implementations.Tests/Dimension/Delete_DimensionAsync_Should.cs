...
//     public class Delete_DimensionAsync_Should : SourceFormatFeature
//     {
//         public Delete_DimensionAsync_Should()
//             : base(TestInfo)
//         {
//         }
//
...
//                 IsActive = 1,
//             };
//             Dimension dimension1Result = await _masterDataBusinessLogic.AddDimensionAsync(dimension1)
...
//                 IsActive = 1,
//             };
//             Dimension dimension2Result = await _masterDataBusinessLogic.AddDimensionAsync(dimension2)
//                .ConfigureAwait(false);
//
//             // Act
//             await _masterDataBusinessLogic.DeleteDimensionAsync(dimension2Result).ConfigureAwait(false);
//
//             // Assert
//             List<Dimension> result = await _masterDataBusinessLogic.GetDimensionsAsync().ConfigureAwait(false);
