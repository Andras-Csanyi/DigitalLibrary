...
//     public class Update_SourceFormat_NameDescIsActive_Should : SourceFormatFeature
//     {
...
//             };
//
//             SourceFormat origRes = await _masterDataBusinessLogic.AddSourceFormatAsync(
...
//
//             // Act
//             SourceFormat res = await _masterDataBusinessLogic.UpdateSourceFormatAsync(mod)
...
//                 IsActive = 1,
//             };
//             SourceFormat sourceFormat2Result = await _masterDataBusinessLogic.AddSourceFormatAsync(sourceFormat2)
//                .ConfigureAwait(false);
//
