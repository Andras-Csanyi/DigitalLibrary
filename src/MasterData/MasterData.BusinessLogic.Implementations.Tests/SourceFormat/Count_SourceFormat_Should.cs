...
//     public class Count_SourceFormat_Should : SourceFormatFeature
//     {
...
//             };
//
//             SourceFormat result2 = await _masterDataBusinessLogic.AddSourceFormatAsync(
//                 sourceFormat2).ConfigureAwait(false);
//
//             // Act
//             long count = await _masterDataBusinessLogic.CountSourceFormatsAsync().ConfigureAwait(false);
//
//             // Act
...
//
//             // Act
//             long count = await _masterDataBusinessLogic.CountSourceFormatsAsync()
