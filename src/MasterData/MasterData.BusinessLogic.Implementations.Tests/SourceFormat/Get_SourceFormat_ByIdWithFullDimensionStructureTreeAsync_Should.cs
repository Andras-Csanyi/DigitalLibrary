...
//     public class Get_SourceFormat_ByIdWithFullDimensionStructureTreeAsync_Should : SourceFormatFeature
//     {
...
//                 IsActive = 1,
//             };
//             SourceFormat sourceFormatResult = await _masterDataBusinessLogic.AddSourceFormatAsync(sourceFormat)
...
//                 IsActive = 1,
//             };
//             DimensionStructure rootDimensionStructureResult = await _masterDataBusinessLogic.AddDimensionStructureAsync(
//                 rootDimensionStructure).ConfigureAwait(false);
//             sourceFormatResult.RootDimensionStructureId = rootDimensionStructureResult.Id;
//             SourceFormat updatedSourceFormatResult = await _masterDataBusinessLogic.UpdateSourceFormatAsync(
//                 sourceFormatResult).ConfigureAwait(false);
//
//             // Act
//             SourceFormat result = await _masterDataBusinessLogic.GetSourceFormatByIdWithFullDimensionStructureTreeAsync(
...
//                 IsActive = 1,
//             };
//             DimensionStructure dimensionStructureFirstLevelOneResult = await _masterDataBusinessLogic
...
//                 await _masterDataBusinessLogic.AddDimensionStructureDimensionStructureAsync(
...
//                 IsActive = 1,
//             };
//             DimensionStructure dimensionStructureFirstLevelTwoResult = await _masterDataBusinessLogic
...
//                 IsActive = 1,
//             };
//             DimensionStructure dimensionStructureFirstLevelSecondResult = await _masterDataBusinessLogic
...
//                 IsActive = 1,
//             };
//             DimensionStructure dimensionStructureFirstLevelOneSecondLevelOneResult = await _masterDataBusinessLogic
...
//                 IsActive = 1,
//             };
//             DimensionStructure dimensionStructureFirstLevelOneSecondLevelSecondResult = await _masterDataBusinessLogic
...
//                 IsActive = 1,
//             };
//             DimensionStructure dimensionStructureFirstLevelSecondSecondLevelOneResult = await _masterDataBusinessLogic
...
//                 IsActive = 1,
//             };
//             DimensionStructure dimensionStructureFirstLevelSecondSecondLevelSecondResult = await _masterDataBusinessLogic
