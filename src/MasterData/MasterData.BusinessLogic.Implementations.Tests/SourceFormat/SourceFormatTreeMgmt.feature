Feature: Source format and its tree management
  ...
  Scenario: Adding a SourceFormat with multiple DimensionStructure at first level
    ...
    And there is a saved DimensionStructure domain object
      | Field     | Value             |
      | ResultKey | ds-child-1-result |

    And there is a saved DimensionStructure domain object
      | Field     | Value             |
      | ResultKey | ds-child-2-result |

    And there is a saved DimensionStructure domain object
      | Field     | Value             |
      | ResultKey | ds-child-3-result |

    And DimensionStructure is added to DimensionStructure as child in tree of SourceFormat
      | Field           | Value             |
      | ChildKey        | ds-child-1-result |
      | ParentKey       | ds-root-result    |
      | SourceFormatKey | sf-1-result       |

    And DimensionStructure is added to DimensionStructure as child in tree of SourceFormat
      | Field           | Value             |
      | ChildKey        | ds-child-2-result |
      | ParentKey       | ds-root-result    |
      | SourceFormatKey | sf-1-result       |

    And DimensionStructure is added to DimensionStructure as child in tree of SourceFormat
      | Field           | Value             |
      | ChildKey        | ds-child-3-result |
      | ParentKey       | ds-root-result    |
      | SourceFormatKey | sf-1-result       |

    And DimensionStructure is deleted from the tree
      | Field                 | Value                    |
      | DimensionStructureKey | ds-child-1-result        |
      | SourceFormatKey       | sf-1-result              |
      | ResultKey             | ds-child-1-delete-result |
    ...
    And DimensionStructure is deleted from the tree
      | Field                 | Value                    |
      | DimensionStructureKey | ds-child-2-result        |
      | SourceFormatKey       | sf-1-result              |
      | ResultKey             | ds-child-2-delete-result |
    ...
    And DimensionStructure is deleted from the tree
      | Field                 | Value                    |
      | DimensionStructureKey | ds-child-3-result        |
      | SourceFormatKey       | sf-1-result              |
      | ResultKey             | ds-child-3-delete-result |
