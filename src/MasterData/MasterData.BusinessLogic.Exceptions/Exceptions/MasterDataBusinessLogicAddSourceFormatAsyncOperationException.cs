// <copyright file="MasterDataBusinessLogicAddSourceFormatAsyncOperationException.cs" company="Andras Csanyi">
...
namespace DigitalLibrary.MasterData.BusinessLogic.Exceptions
{
    ...
    public class MasterDataBusinessLogicAddSourceFormatAsyncOperationException : Exception
    {
        ...
        public MasterDataBusinessLogicAddSourceFormatAsyncOperationException(string? message)
            : base(message)
        {
        }
