// <copyright file="MasterDataBusinessLogicGetSourceFormatByIdAsyncOperationException.cs" company="Andras Csanyi">
...
namespace DigitalLibrary.MasterData.BusinessLogic.Exceptions
{
    ...
    public class MasterDataBusinessLogicGetSourceFormatByIdAsyncOperationException : Exception
    {
        ...
        public MasterDataBusinessLogicGetSourceFormatByIdAsyncOperationException(string? message)
            : base(message)
        {
        }
