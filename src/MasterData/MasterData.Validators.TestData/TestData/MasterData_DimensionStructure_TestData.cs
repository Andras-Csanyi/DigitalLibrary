namespace DigitalLibrary.IaC.MasterData.Validators.TestData.TestData
{
    ...
    public static class MasterData_DimensionStructure_TestData
    {
        ...
        {
            new object[] { 1, 0, null, "desc", 1 },
            new object[] { 1, 0, string.Empty, "desc", 1 },
            new object[] { 1, 0, "as", "desc", 1 },

            new object[] { 1, 0, "name", null, 1 },
            new object[] { 1, 0, "name", string.Empty, 1 },
            new object[] { 1, 0, "name", "de", 1 },

            new object[] { 1, 0, "name", "desc", 2 },
        };
