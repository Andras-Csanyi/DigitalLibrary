...
//                 Name = "test",
//                 Desc = "test desc",
//                 DimensionStructureTreeRootId = 100,
//                 DimensionStructureTreeRoot = rootDimensionStructure,
//             };
//
...
//
//             builderService.SourceFormat.DimensionStructureTreeRoot.Id.Should().Be(rootDimensionStructure.Id);
//
//             builderService.SourceFormat.DimensionStructureTreeRoot.ChildDimensionStructureTreeNodes.Count.Should().Be(1);
//
//             builderService.SourceFormat.DimensionStructureTreeRoot.ChildDimensionStructureTreeNodes
...
//             builderService.SourceFormat.DimensionStructureTreeRoot.Id.Should().Be(rootDimensionStructure.Id);
//
//             builderService.SourceFormat.DimensionStructureTreeRoot.ChildDimensionStructureTreeNodes.Count.Should().Be(0);
//         }
//
//         [Fact]
...
//             builderService.SourceFormat.DimensionStructureTreeRoot.ChildDimensionStructureTreeNodes.Count.Should().Be(3);
//             builderService.SourceFormat.DimensionStructureTreeRoot.ChildDimensionStructureTreeNodes
...
//             builderService.SourceFormat.DimensionStructureTreeRoot.Id.Should().Be(rootDimensionStructure.Id);
//
//             builderService.SourceFormat.DimensionStructureTreeRoot.ChildDimensionStructureTreeNodes.Count.Should().Be(2);
//             builderService.SourceFormat.DimensionStructureTreeRoot.ChildDimensionStructureTreeNodes
//                .Where(p => p.Id == firstLevelFirst.Id).ToList().Count.Should().Be(1);
//             builderService.SourceFormat.DimensionStructureTreeRoot.ChildDimensionStructureTreeNodes
//                .Where(p => p.Id == firstLevelSecond.Id).ToList().Count.Should().Be(1);
