...
//
//             // Assert
//             sourceFormatBuilderService.SourceFormat.DimensionStructureTreeRoot.Id
//                .Should().Be(dimensionStructure.Id);
//             sourceFormatBuilderService.SourceFormat.DimensionStructureTreeRoot.Name
//                .Should().Be(dimensionStructure.Name);
//             sourceFormatBuilderService.SourceFormat.DimensionStructureTreeRoot.Desc
//                .Should().Be(dimensionStructure.Desc);
//             sourceFormatBuilderService.SourceFormat.DimensionStructureTreeRoot.IsActive
