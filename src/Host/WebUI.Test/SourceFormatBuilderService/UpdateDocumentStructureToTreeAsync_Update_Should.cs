...
//
//             DimensionStructure toBeReplaced = _sourceFormatDataOnTheFirstLevel.DimensionStructureTreeRoot
//                .ChildDimensionStructureTreeNodes
//                .ElementAt(0);
//
//             // Act
...
//
//             // Assert
//             sourceFormatBuilderService.SourceFormat.DimensionStructureTreeRoot
//                .ChildDimensionStructureTreeNodes
...
//             await sourceFormatBuilderService.OnUpdate(100).ConfigureAwait(false);
//
//             DimensionStructure firstLevelNode = _sourceFormatDataOnTheSecondLevel.DimensionStructureTreeRoot
//                .ChildDimensionStructureTreeNodes
//                .ElementAt(0);
//
...
//             await sourceFormatBuilderService.OnUpdate(100).ConfigureAwait(false);
//
//             DimensionStructure firstLevelNode = _sourceFormatDataOnTheThirdLevel.DimensionStructureTreeRoot
//                .ChildDimensionStructureTreeNodes
//                .ElementAt(0);
//
...
//             await sourceFormatBuilderService.OnUpdate(100).ConfigureAwait(false);
//
//             DimensionStructure toBeReplaced = _sourceFormatDataOnTheThirdLevel.DimensionStructureTreeRoot;
//
//             // Act
//             await sourceFormatBuilderService.UpdateDocumentStructureInTheTreeAsync(
//                     newOne,
...
//                .Should().Be(0);
//
//             sourceFormatBuilderService.SourceFormat.DimensionStructureTreeRoot.Name.Should().Be(newOne.Name);
//             sourceFormatBuilderService.SourceFormat.DimensionStructureTreeRoot.Desc.Should().Be(newOne.Desc);
//             sourceFormatBuilderService.SourceFormat.DimensionStructureTreeRoot.Guid.Should().Be(newOne.Guid);
//         }
//     }
// }
