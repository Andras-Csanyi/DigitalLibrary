...
//                     newOne,
//                     _sourceFormat.DimensionStructureTreeRoot.Guid)
...
//                 Desc = "second one",
//             };
//             _sourceFormat.DimensionStructureTreeRoot.ChildDimensionStructureTreeNodes.Add(firstOne);
//
//             _masterDataWebApiClientMock
//                .Setup(m => m.GetSourceFormatWithFullDimensionStructureTreeAsync(It.IsAny<SourceFormat>()))
//                .ReturnsAsync(_sourceFormat);
...
//                .Be(2);
//
//             DimensionStructure res = sourceFormatBuilderService.SourceFormat.DimensionStructureTreeRoot
//                .ChildDimensionStructureTreeNodes
...
//             };
//
//             _sourceFormat.DimensionStructureTreeRoot.ChildDimensionStructureTreeNodes.Add(toRootFirst);
//             _sourceFormat.DimensionStructureTreeRoot.ChildDimensionStructureTreeNodes.Add(toRootSecond);
//
//             _masterDataWebApiClientMock
//                .Setup(m => m.GetSourceFormatWithFullDimensionStructureTreeAsync(It.IsAny<SourceFormat>()))
//                .ReturnsAsync(_sourceFormat);
...
//
//             // Assert
//             sourceFormatBuilderService.SourceFormat.DimensionStructureTreeRoot.ChildDimensionStructureTreeNodes
//                .Count
//                .Should().Be(2);
//
//             DimensionStructure toFirstResult = sourceFormatBuilderService.SourceFormat
//                .DimensionStructureTreeRoot
//                .ChildDimensionStructureTreeNodes
